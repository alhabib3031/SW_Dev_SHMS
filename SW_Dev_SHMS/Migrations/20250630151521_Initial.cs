    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DormManager", x => x.ManagerId);
                    table.ForeignKey(
                        name: "FK_DormManager_Hostel_HostelId",
                        column: x => x.HostelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    DormManagerManagerId = table.Column<int>(type: "int", nullable: true),
                    RequestId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DormStudent", x => x.StudentId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_DormStudent_Request_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Request",
                        principalColumn: "RequestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DormStudent_Room_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Room",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notification_ManagerId",
                table: "Notification",
                column: "ManagerId");
